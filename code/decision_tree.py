...
print("Average Power Loss for DecisionTreeClassifier:", average_power_loss)
print("Top-k Accuracy for DecisionTreeClassifier:", top_k)
...
plt.title('Actual vs. Predicted Beam Indices (Decision Tree)')
